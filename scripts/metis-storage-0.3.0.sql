drop database if exists `metis_storage_0.3.0`;

CREATE DATABASE `metis_storage_0.3.0` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE `metis_storage_0.3.0`;
