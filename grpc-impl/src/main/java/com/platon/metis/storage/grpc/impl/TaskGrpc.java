...
public class TaskGrpc extends TaskServiceGrpc.TaskServiceImplBase {
    ...
    public void saveTask(com.platon.metis.storage.grpc.lib.api.SaveTaskRequest request,
        ...
        int dataPolicyType = taskPB.getDataPolicyType();
        String dataPolicyOption = taskPB.getDataPolicyOption();
        int powerPolicyType = taskPB.getPowerPolicyType();
        String powerPolicyOption = taskPB.getPowerPolicyOption();
        int dataFlowPolicyType = taskPB.getDataFlowPolicyType();
        String dataFlowPolicyOption = taskPB.getDataFlowPolicyOption();
        ...
        taskInfo.setDataPolicyType(dataPolicyType);
        taskInfo.setPowerPolicyType(powerPolicyType);
        taskInfo.setDataFlowPolicyType(dataFlowPolicyType);
