drop database if exists `datum_storage`;

CREATE DATABASE `datum_storage` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `org_info` (
                            `identity_type` tinyint NOT NULL COMMENT '身份认证标识的类型 0-未知, 1-DID',
