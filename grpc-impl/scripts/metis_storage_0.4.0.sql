...
Source Database       : metis_storage_0.4.0
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_data_file_stats_daily` AS select `a`.`stats_time` AS `stats_time`,`a`.`day_size` AS `day_size`,sum(`b`.`day_size`) AS `accu_size` from (((select cast(`df`.`published_at` as date) AS `stats_time`,sum(`df`.`size`) AS `day_size` from `metis_storage_0.4.0`.`data_file` `df` where (`df`.`status` = 2) group by cast(`df`.`published_at` as date) order by cast(`df`.`published_at` as date))) `a` join (select cast(`df`.`published_at` as date) AS `stats_time`,sum(`df`.`size`) AS `day_size` from `metis_storage_0.4.0`.`data_file` `df` where (`df`.`status` = 2) group by cast(`df`.`published_at` as date) order by cast(`df`.`published_at` as date)) `b` on((`a`.`stats_time` >= `b`.`stats_time`))) group by `a`.`stats_time` order by `a`.`stats_time` ;

-- ----------------------------
-- View structure for v_data_file_stats_monthly
-- ----------------------------
DROP VIEW IF EXISTS `v_data_file_stats_monthly`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_data_file_stats_monthly` AS select `a`.`stats_time` AS `stats_time`,`a`.`month_size` AS `month_size`,sum(`b`.`month_size`) AS `accu_size` from (((select date_format(`df`.`published_at`,'%Y-%m') AS `stats_time`,sum(`df`.`size`) AS `month_size` from `metis_storage_0.4.0`.`data_file` `df` where (`df`.`status` = 2) group by date_format(`df`.`published_at`,'%Y-%m') order by date_format(`df`.`published_at`,'%Y-%m'))) `a` join (select date_format(`df`.`published_at`,'%Y-%m') AS `stats_time`,sum(`df`.`size`) AS `month_size` from `metis_storage_0.4.0`.`data_file` `df` where (`df`.`status` = 2) group by date_format(`df`.`published_at`,'%Y-%m') order by date_format(`df`.`published_at`,'%Y-%m')) `b` on((`a`.`stats_time` >= `b`.`stats_time`))) group by `a`.`stats_time` order by `a`.`stats_time` ;

-- ----------------------------
-- View structure for v_global_stats
-- ----------------------------
DROP VIEW IF EXISTS `v_global_stats`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_global_stats` AS select `allOrg`.`total_org_count` AS `total_org_count`,`powerOrg`.`power_org_count` AS `power_org_count`,`srcFile`.`data_file_size` AS `data_file_size`,`usedFile`.`used_data_file_size` AS `used_data_file_size`,`task`.`task_count` AS `task_count`,(`partner`.`partner_count` + `task`.`task_count`) AS `partner_count`,`power`.`total_core` AS `total_core`,`power`.`total_memory` AS `total_memory`,`power`.`total_bandwidth` AS `total_bandwidth` from (((((((select count(0) AS `total_org_count` from `metis_storage_0.4.0`.`org_info` where (`metis_storage_0.4.0`.`org_info`.`status` = 1)) `allOrg` join (select count(`oi`.`identity_id`) AS `power_org_count` from `metis_storage_0.4.0`.`org_info` `oi` where (exists(select 1 from `metis_storage_0.4.0`.`power_server` `ps` where ((`oi`.`identity_id` = `ps`.`identity_id`) and (`ps`.`status` in (2,3)))) and (`oi`.`status` = 1))) `powerOrg`) join (select ifnull(sum(`metis_storage_0.4.0`.`data_file`.`size`),0) AS `data_file_size` from `metis_storage_0.4.0`.`data_file` where (`metis_storage_0.4.0`.`data_file`.`status` = 2)) `srcFile`) join (select ifnull(sum(`df`.`size`),0) AS `used_data_file_size` from (`metis_storage_0.4.0`.`task_meta_data` `tmd` left join `metis_storage_0.4.0`.`data_file` `df` on((`tmd`.`meta_data_id` = `df`.`meta_data_id`)))) `usedFile`) join (select count(0) AS `task_count` from `metis_storage_0.4.0`.`task`) `task`) join (select (((ifnull(`dataPartner`.`dataPartnerCount`,0) + ifnull(`powerPartner`.`powerPartnerCount`,0)) + ifnull(`algoPartner`.`algoPartnerCount`,0)) + ifnull(`resultConsumerPartner`.`resultConsumerPartnerCount`,0)) AS `partner_count` from ((((select count(0) AS `dataPartnerCount` from `metis_storage_0.4.0`.`task_meta_data`) `dataPartner` join (select count(0) AS `powerPartnerCount` from `metis_storage_0.4.0`.`task_power_provider`) `powerPartner`) join (select count(0) AS `algoPartnerCount` from `metis_storage_0.4.0`.`task_algo_provider`) `algoPartner`) join (select count(0) AS `resultConsumerPartnerCount` from `metis_storage_0.4.0`.`task_result_consumer`) `resultConsumerPartner`)) `partner`) join (select ifnull(sum(`p`.`core`),0) AS `total_core`,ifnull(sum(`p`.`memory`),0) AS `total_memory`,ifnull(sum(`p`.`bandwidth`),0) AS `total_bandwidth` from (`metis_storage_0.4.0`.`power_server` `p` join `metis_storage_0.4.0`.`org_info` `o` on((`p`.`identity_id` = `o`.`identity_id`))) where ((`o`.`status` = 1) and (`p`.`status` in (2,3)))) `power`) ;

-- ----------------------------
-- View structure for v_org_daily_task_stats
-- ----------------------------
DROP VIEW IF EXISTS `v_org_daily_task_stats`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_org_daily_task_stats` AS select `tmp`.`identity_id` AS `identity_id`,count(`tmp`.`task_id`) AS `task_count`,cast(`t`.`create_at` as date) AS `task_date` from ((select `oi`.`identity_id` AS `identity_id`,`t`.`id` AS `task_id` from (`metis_storage_0.4.0`.`org_info` `oi` join `metis_storage_0.4.0`.`task` `t`) where (`oi`.`identity_id` = `t`.`owner_identity_id`) union select `oi`.`identity_id` AS `identity_id`,`tap`.`task_id` AS `task_id` from (`metis_storage_0.4.0`.`org_info` `oi` join `metis_storage_0.4.0`.`task_algo_provider` `tap`) where (`oi`.`identity_id` = `tap`.`identity_id`) union select `oi`.`identity_id` AS `identity_id`,`tpp`.`task_id` AS `task_id` from (`metis_storage_0.4.0`.`org_info` `oi` join `metis_storage_0.4.0`.`task_power_provider` `tpp`) where (`oi`.`identity_id` = `tpp`.`identity_id`) union select `oi`.`identity_id` AS `identity_id`,`tmd`.`task_id` AS `task_id` from (`metis_storage_0.4.0`.`org_info` `oi` join `metis_storage_0.4.0`.`task_meta_data` `tmd`) where (`oi`.`identity_id` = `tmd`.`identity_id`) union select `oi`.`identity_id` AS `identity_id`,`trc`.`task_id` AS `task_id` from (`metis_storage_0.4.0`.`org_info` `oi` join `metis_storage_0.4.0`.`task_result_consumer` `trc`) where (`oi`.`identity_id` = `trc`.`consumer_identity_id`)) `tmp` join `metis_storage_0.4.0`.`task` `t`) where (`tmp`.`task_id` = `t`.`id`) group by `tmp`.`identity_id`,`task_date` ;

-- ----------------------------
-- View structure for v_power_stats_daily
-- ----------------------------
DROP VIEW IF EXISTS `v_power_stats_daily`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_power_stats_daily` AS select `a`.`stats_time` AS `stats_time`,`a`.`day_core` AS `day_core`,`a`.`day_memory` AS `day_memory`,`a`.`day_bandwidth` AS `day_bandwidth`,sum(`b`.`day_core`) AS `accu_core`,sum(`b`.`day_memory`) AS `accu_memory`,sum(`b`.`day_bandwidth`) AS `accu_bandwidth` from (((select cast(`ps`.`published_at` as date) AS `stats_time`,sum(`ps`.`core`) AS `day_core`,sum(`ps`.`memory`) AS `day_memory`,sum(`ps`.`bandwidth`) AS `day_bandwidth` from `metis_storage_0.4.0`.`power_server` `ps` where ((`ps`.`status` = 2) or (`ps`.`status` = 3)) group by cast(`ps`.`published_at` as date) order by cast(`ps`.`published_at` as date))) `a` join (select cast(`ps`.`published_at` as date) AS `stats_time`,sum(`ps`.`core`) AS `day_core`,sum(`ps`.`memory`) AS `day_memory`,sum(`ps`.`bandwidth`) AS `day_bandwidth` from `metis_storage_0.4.0`.`power_server` `ps` where ((`ps`.`status` = 2) or (`ps`.`status` = 3)) group by cast(`ps`.`published_at` as date) order by cast(`ps`.`published_at` as date)) `b` on((`a`.`stats_time` >= `b`.`stats_time`))) group by `a`.`stats_time` order by `a`.`stats_time` ;

-- ----------------------------
-- View structure for v_power_stats_monthly
-- ----------------------------
DROP VIEW IF EXISTS `v_power_stats_monthly`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_power_stats_monthly` AS select `a`.`stats_time` AS `stats_time`,`a`.`month_core` AS `month_core`,`a`.`month_memory` AS `month_memory`,`a`.`month_bandwidth` AS `month_bandwidth`,sum(`b`.`month_core`) AS `accu_core`,sum(`b`.`month_memory`) AS `accu_memory`,sum(`b`.`month_bandwidth`) AS `accu_bandwidth` from (((select date_format(`ps`.`published_at`,'%Y-%m') AS `stats_time`,sum(`ps`.`core`) AS `month_core`,sum(`ps`.`memory`) AS `month_memory`,sum(`ps`.`bandwidth`) AS `month_bandwidth` from `metis_storage_0.4.0`.`power_server` `ps` where ((`ps`.`status` = 2) or (`ps`.`status` = 3)) group by date_format(`ps`.`published_at`,'%Y-%m') order by date_format(`ps`.`published_at`,'%Y-%m'))) `a` join (select date_format(`ps`.`published_at`,'%Y-%m') AS `stats_time`,sum(`ps`.`core`) AS `month_core`,sum(`ps`.`memory`) AS `month_memory`,sum(`ps`.`bandwidth`) AS `month_bandwidth` from `metis_storage_0.4.0`.`power_server` `ps` where ((`ps`.`status` = 2) or (`ps`.`status` = 3)) group by date_format(`ps`.`published_at`,'%Y-%m') order by date_format(`ps`.`published_at`,'%Y-%m')) `b` on((`a`.`stats_time` >= `b`.`stats_time`))) group by `a`.`stats_time` order by `a`.`stats_time` ;
