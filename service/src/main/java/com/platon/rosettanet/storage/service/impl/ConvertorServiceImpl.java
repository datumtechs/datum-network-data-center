...
public class ConvertorServiceImpl implements ConvertorService {
    ...
    @Override
    public com.platon.rosettanet.storage.grpc.lib.types.MetadataPB toProtoMetadataPB(DataFile dataFile) {
        /*OrgInfo orgInfo = orgInfoService.findByPK(dataFile.getIdentityId());
        if(orgInfo==null){
            log.error("identity not found. identityId:={}", dataFile.getIdentityId());
            throw new OrgNotFound();
    ...
    @Override
    public List<com.platon.rosettanet.storage.grpc.lib.types.TaskPB> toTaskPB(List<Task> taskList) {
        List<com.platon.rosettanet.storage.grpc.lib.types.TaskPB> grpcTaskList =
    ...
    public com.platon.rosettanet.storage.grpc.lib.types.TaskPB toTaskPB(Task task) {
        ...
        return com.platon.rosettanet.storage.grpc.lib.types.TaskPB.newBuilder()
