...
//        }).collect(Collectors.toList());
//    }
    public List<com.platon.metis.storage.grpc.lib.types.Base.TaskOrganization> toProtoResultReceiver(List<TaskResultConsumer> taskResultConsumerList) {
    ...
    public com.platon.metis.storage.grpc.lib.types.Base.TaskOrganization toProtoTaskOrganization(OrgInfo orgInfo, String partyId) {
...
//                .setOperationCost(com.platon.metis.storage.grpc.lib.types.Base.TaskResourceCostDeclare.newBuilder().setProcessor(task.getRequiredCore()).setMemory(task.getRequiredMemory()).setBandwidth(task.getRequiredBandwidth()).setDuration(task.getRequiredDuration()).build())
