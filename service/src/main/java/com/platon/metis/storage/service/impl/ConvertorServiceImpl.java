...
public class ConvertorServiceImpl implements ConvertorService {
    ...
    @Override
    public List<com.platon.metis.storage.grpc.carrier.types.TaskData.TaskEvent> toProtoTaskEvent(List<com.platon.metis.storage.dao.entity.TaskEvent> taskEventList) {
    ...
    @Override
    public com.platon.metis.storage.grpc.carrier.types.TaskData.TaskEvent toProtoTaskEvent(com.platon.metis.storage.dao.entity.TaskEvent taskEvent) {
        return com.platon.metis.storage.grpc.carrier.types.TaskData.TaskEvent.newBuilder()
    ...
    public Metadata.MetadataSummaryOwner toProtoMetaDataSummaryWithOwner(MetaData dataFile) {
        ...
        //1.组装整个元数据摘要
        com.platon.metis.storage.grpc.carrier.types.Metadata.MetadataSummary metadataSummary = com.platon.metis.storage.grpc.carrier.types.Metadata.MetadataSummary.newBuilder()
    ...
    @Override
    public com.platon.metis.storage.grpc.carrier.types.Metadata.MetadataPB toProtoMetadataPB(MetaData dataFile) {
        OrgInfo orgInfo = orgInfoService.findByPK(dataFile.getIdentityId());
        if (orgInfo == null) {
            log.error("identity not found. identityId:={}", dataFile.getIdentityId());
            throw new OrgNotFound();
        ...
        //1.组装整个元数据
        return com.platon.metis.storage.grpc.carrier.types.Metadata.MetadataPB.newBuilder()
                .setOwner(owner)
                .setMetadataId(dataFile.getMetaDataId())
                .setMetadataName(dataFile.getMetaDataName())
                .setDataType(CarrierEnum.OrigindataType.forNumber(dataFile.getDataType()))
    ...
    @Override
    public List<com.platon.metis.storage.grpc.carrier.types.Metadata.MetadataPB> toProtoMetadataPB(List<MetaData> dataFileList) {
        return dataFileList.stream().map(dataFile -> {
    ...
    public TaskData.TaskPB toTaskPB(TaskInfo taskInfo) {
        ...
        List<com.platon.metis.storage.grpc.carrier.types.TaskData.TaskPowerResourceOption> powerResourceOptionList = list.stream()
                .map(option -> {
                    ...
                    com.platon.metis.storage.grpc.carrier.types.TaskData.TaskPowerResourceOption taskPowerResourceOption =
                            com.platon.metis.storage.grpc.carrier.types.TaskData.TaskPowerResourceOption.newBuilder()
        ...
        //组装最终响应体
        return com.platon.metis.storage.grpc.carrier.types.TaskData.TaskPB.newBuilder()
                .setTaskId(taskId)
    ...
    @Override
    public List<com.platon.metis.storage.grpc.carrier.types.TaskData.TaskPB> toTaskPB(List<TaskInfo> taskInfoList) {
        List<com.platon.metis.storage.grpc.carrier.types.TaskData.TaskPB> grpcTaskList = taskInfoList.stream()
                .map(this::toTaskPB)
                .collect(Collectors.toList());
        return grpcTaskList;
    }
    ...
    @Override
    public com.platon.metis.storage.grpc.carrier.types.Metadata.MetadataAuthorityPB toProtoMetadataAuthorityPB(MetaDataAuth metaDataAuth) {
        ...
        return com.platon.metis.storage.grpc.carrier.types.Metadata.MetadataAuthorityPB.newBuilder()
                ...
                .setAuth(com.platon.metis.storage.grpc.carrier.types.Metadata.MetadataAuthority.newBuilder()
                        ...
                        .setOwner(IdentityData.Organization.newBuilder()
                                ...
                                .setStatus(CarrierEnum.CommonStatus.forNumber(orgInfo.getStatus()))
                                .build())
                        .setUsageRule(com.platon.metis.storage.grpc.carrier.types.Metadata.MetadataUsageRule.newBuilder()
                ...
                .setUsedQuo(com.platon.metis.storage.grpc.carrier.types.Metadata.MetadataUsedQuo.newBuilder().setUsageType(CarrierEnum.MetadataUsageType.forNumber(metaDataAuth.getUsageType()))
